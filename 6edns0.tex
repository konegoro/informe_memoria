...
como el tamaño máximo de los mensajes y la capacidad de transportar información adicional. Fue definido en el RFC 2671 y posteriormente actualizado por el RFC 6891. 
...
Para habilitar EDNS0, los clientes y servidores DNS incluyen un registro especial en sus mensajes DNS llamado "OPT" (Option), el cual va en la seccción Additional.
...
\begin{itemize}
    ...
    \item \textbf{TTL}: Se utiliza para transportar varias opciones y banderas.
                        \begin{itemize}
                            \item \textbf{Extended RCODE} : Los primeros 8 bits representan el RCODE extendido.
...
como parámetros el nombre de dominio, el tipo de consulta y retorna una una consulta DNS que incluye un registro OPT en la sección Additional, usando como tamaño máximo de mensaje 4096 bytes.
