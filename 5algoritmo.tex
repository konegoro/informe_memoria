...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{diagramas/add_glue_records_and_wildcard.png}
...
respuesta DNS tendrá todos los \textit{RRs} del \textit{RRset} en la sección \texttt{Answer}, además de los \textit{RRSIG} correspondientes:\\
...
existe un registro \textit{glue} correspondiente y, de ser así, añadirlo en la sección \texttt{Additional}.\\
...
\subsubsection{Consulta sin coincidencia en el nombre de dominio pero existe un wildcard}
