...
\begin{itemize}
    ...
    \item Glue Record: RR especial que contiene la IP de un Name Server delegado en otra zona, usado para evitar ciclos de referencias.
    \item Wildcard: Nombre de dominio especial que permite que subdominios no definidos respondan con la misma información, usando un asterisco (*). Por ejemplo, *.niclabs.cl puede responder a consultas 
          como a.niclabs.cl o b.c.niclabs.cl.
    \item NXDOMAIN : Código de error que indica que el nombre de dominio consultado no existe.
    \item NO\_DATA : Código de error que indica que el nombre de dominio consultado existe, pero no posee registros del tipo solicitado.
\end{itemize}
